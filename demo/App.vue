...
import type { ToolbarConfig, CustomButton } from '../src/types'
import '../src/styles/editor.scss'
import '../src/styles/toolbar.scss'
import '../src/styles/dialogs.scss'
import '../src/styles/editor-content.scss'
...
const configurableContent = ref('<p>This editor has a configurable toolbar. Toggle the buttons on the left to show/hide them!</p>')
...
const customContent = ref('<p>This editor has custom buttons in the toolbar!</p>')
...
const readonlyContent = ref('<p>This editor can be toggled between <strong>editable</strong> and <strong>read-only</strong> modes.</p><p>Click the button above to toggle the mode!</p>')
  ...
  <div class="demo-container">
    <div class="container">
      ...
      <div class="demo-section">
        ...
        <p class="section-desc">
          Add your own custom buttons with custom functionality:
        </p>
        <RichTextEditor 
